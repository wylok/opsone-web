  ...
  <div class="app-container">
    ...
    <div class="app-div">
      ...
      >
        ...
        <el-table-column label="作业命令" width="auto" align="center">
          <template slot-scope="scope">
            {{ scope.row['exec'] }}
          </template>
        </el-table-column>
        ...
        <el-table-column label="作业结果" align="center" width="auto">
          <template slot-scope="scope">
            <el-link
              ...
              type="primary"
              @click="getJobDetail(scope.row['job_id'],scope.row['host_id'],scope.row['exec'])"
            >查看
            </el-link>
...
import { getJobExecList, getJobResults } from '@/api/job'
...
export default {
  ...
  methods: {
    async getData(params) {
      ...
      let data = []
      await getJobExecList(params).then((res) => {
        if (res.success) {
          data = res.data
          res.data.forEach((v) => {
